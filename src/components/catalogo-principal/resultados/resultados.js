                    ...
                    {this.props.resultados != null
                        ? this.props.resultados.map((resultado, index) => {
                              return (
                                  <div
                                      key={index}
                                      className="card resultado col-2 pl-0 pr-0 mr-3 mb-3 border-0"
                                  >
                                      <img
                                      ...
                                      <div className="card-body pl-0 pt-1 pb-2">
                                          <label className="card-text mb-0 pb-0">
                                              {resultado.title}
                                          </label>{" "}
                                          <br />
                                          <label className="card-text text-muted">
